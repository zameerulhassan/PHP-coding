...
<form method='post' action='upload222.php' enctype='multipart/form-data'>
...
if ($_FILES){
    ...
    $finfo = new finfo();
    $mime = $finfo->file($_FILES['filename']['name'], FILEINFO_MIME_TYPE);
    echo $mime."<br>";
    move_uploaded_file($_FILES['filename']['name'], $mime);
    echo "Uploaded image '$name' as '$mime'<br />";
    //echo "<img src='$mime' />";
}
