<?php // sqlQuery3.php
//adding and deleting items in database.
$user = 'root';
$pass ='';
$db = 'testDB';
...
{
return mysqli_real_escape_string($_POST[$var]); //function to remove suspicious character hacker could add.i.e. sanitize it
}
